...
const CalendarView: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const mockScheduled = {
      '15': [{ id: 'mock-1', prompt: 'Weekly AI Roundup', tweets: [{id:'t1', content: '...', media: null, isLoadingMedia: false, isCopied: false}], createMode: 'text' as const, audience: '', createdAt: '' }],
      '22': [{ id: 'mock-2', prompt: 'New feature launch announcement', tweets: [{id:'t2', content: '...', media: null, isLoadingMedia: false, isCopied: false}], createMode: 'text' as const, audience: '', createdAt: '' }],
    };
